...
const About = () => {
  const volunteers = [
    ...
    },
    {
      ...
      education: 'Persuing Pharamcy',
    },
    {
      name: 'Chirag Rathod',
      role: 'BSC Sah-Sanchalak',
      contact: '+91 9558161280',
      education: 'Persuing Btech (Computer Science)',
    },
    {
      name: 'Yogi Patel',
              ...
              {volunteers.map((volunteer) => (
                ...
                >
                  <div>
                    ...
                    {volunteer?.name &&  <h3 className="text-xl font-bold text-blue-600">{volunteer.name}</h3>}
                   {volunteer?.role &&  <p className="text-lg">{volunteer.role}</p>}
                   { volunteer?.contact && <p className="mt-2"><strong>Contact:</strong> {volunteer.contact}</p>}
                   { volunteer?.education && <p> <strong>Education:</strong> {volunteer.education}</p>}
                  </div>
                </div>
              ))}
